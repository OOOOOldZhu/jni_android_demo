...
public class RepoUtils {
	...
	public static void setVersion(String buildAbi, String ndkArch, int ndkVersion) {
		Log.e("Felix", "Build_ABI:" + buildAbi);
		_buildAbi = buildAbi;
		_ndkArch = ndkArch;
    ...
    private static List<PackageInfo> parseRepoXml(List<PackageInfo> list, String repo, String url) {
		if (repo != null) {
			...
			Log.e("Felix", "Repo size:" + repo.length());
	        if (doc == null) {
				Log.e("Felix", "Parse Failed!");
	        	return list;
	        }
			...
			Log.e("Felix", "Nodelist size:" + nl.getLength());
	    	for (int i = 0; i < nl.getLength(); i++) {
				...
				if (_debug) {
					Log.e(TAG , " added pkg = " + packageInfo.getName());
				}
	    	}
		}
		return list;
